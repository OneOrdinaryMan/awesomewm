...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86MonBrightnessDown", function() awful.util.spawn_with_shell("~/.scripts/brightness.sh -") end,
        { description = "Brightness Down", group = "XF86" }),
    awful.key({}, "XF86MonBrightnessUp", function() awful.util.spawn_with_shell("~/.scripts/brightness.sh +") end,
    ...
    awful.key({ modkey, "Control" }, "n", function() awful.spawn("dunstctl history-pop") end,
        { description = "reload awesome", group = "awesome" }),
    awful.key({ modkey, "Shift" }, "q", function() awful.util.spawn_with_shell("power_controls") end,
        { description = "shutdown script", group = "launcher" }),
    awful.key({ modkey, "Shift" }, "p", function() awful.util.spawn_with_shell("rofi-pass") end,
        { description = "Password menu", group = "launcher" }),
    awful.key({ modkey, "Shift" }, "d", function() awful.util.spawn_with_shell("~/.scripts/dym.sh") end,
